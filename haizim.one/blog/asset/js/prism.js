/* PrismJS 1.28.0
https://prismjs.com/download.html#themes=prism-twilight&languages=markup+css+clike+javascript+graphql+javadoclike+markup-templating+php+phpdoc+php-extras+jsx+tsx+sass+scss+sql+typescript+typoscript&plugins=line-highlight+line-numbers */
...
!function() {
    if ("undefined" != typeof Prism && "undefined" != typeof document && document.querySelector) {
        ...
        Prism.hooks.add("complete", (function e(i) {
            ...
            if (a(n)) {
                ...
                s(n, t) && o && !l ? Prism.hooks.add("line-numbers", e) : (Prism.plugins.lineHighlight.highlightLines(n)(),
                r = setTimeout(u, 1))
            }
        }
        )),
    ...
    function u() {
        ...
        if (t && !document.getElementById(e)) {
            ...
            r && (r.hasAttribute("data-line") || r.setAttribute("data-line", ""),
